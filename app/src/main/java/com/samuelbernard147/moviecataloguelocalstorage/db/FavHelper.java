...
public class FavHelper {
    ...
    /**
     * Method untuk mencari film favorit berdasarkan judul
     * Parameter judul yang dicari, dan tipe (movie/tv)
     * return berupa array model movie
     */
    public ArrayList<Movie> getMovieByTitle(String title, String type) {
        Cursor cursor = database.query(TABLE_NAME,
                null,
                TITLE + " LIKE ? AND " + TYPE + " LIKE ?",
